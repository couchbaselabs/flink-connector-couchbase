...
/**
 * @deprecated uses deprecated APIs
 * @see CouchbaseSource
 */
@Deprecated
public class CouchbaseSourceFunction extends RichParallelSourceFunction<CouchbaseDocumentChange>
    implements CheckpointedFunction {

  private static final Logger log = LoggerFactory.getLogger(CouchbaseSourceFunction.class);
  ...
  public CouchbaseSourceFunction(String seedNodes, String username, String password, String bucketName) {
  ...
  public void run(SourceContext<CouchbaseDocumentChange> ctx) throws Exception {
    ...
    client.listener(new DatabaseChangeListener() {
      ...
      private void onDocumentChange(DocumentChange change) {
        ...
        final CouchbaseDocumentChange item = new CouchbaseDocumentChange(
                type,
                bucketName,
